document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('button').forEach(button => {
        ...
        if (button.className == "dropdown")
        {
            //When clicked, this button shows stuff in the table.
            button.onclick = () =>{

                var tableBodyChildren = button.parentElement.parentElement.parentElement.children;
                ...
                for (let i = 1; i < tableBodyChildren.length; i++)
                {
                    if (tableBodyChildren[i].style.display == "table-row")
                        ...
                        tableBodyChildren[i].style.display = "table-row";
                }
            ...
            for (let i = 1; i < tableBodyChildren.length; i++) tableBodyChildren[i].style.display = "none";
